      ...
      process.nextTick(function() {
        if (err) {
          if (this._events && this._events.error) { // only emit error if it's bound.
            this.emit('error', err, response, purgeRequest, urlSet, options);
          }
          callback(err, response);
          return;
        }

        this.emit('request-success', response, purgeRequest, urlSet, options);
        callback(null, response);
       }.bind(this));
    }.bind(this);

    var purgeRequest = new AkamaiPurgeRequest(urlSet, options, _callback);
  }.bind(this);
...
function AkamaiPurgeRequest(urls, options, callback) {
  var requestBody, startTime = new Date();

  requestBody = new AkamaiPurgeRequestBody(urls, options).toXML();

  // var res = new AkamaiPurgeResponse('<?xml version="1.0" encoding="UTF-8"?>'+
  ...
  var res = new AkamaiPurgeResponse('<?xml version="1.0" encoding="UTF-8"?>'+
    '<SOAP-ENV:Envelope xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/"><SOAP-ENV:Body SOAP-ENV:encodingStyle="http://schemas.xmlsoap.org/soap/encoding/" xmlns:SOAP-ENC="http://schemas.xmlsoap.org/soap/encoding/" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsd1="http://www.w3.org/1999/XMLSchema" xmlns:xsd2="http://www.w3.org/2000/10/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsi1="http://www.w3.org/1999/XMLSchema-instance" xmlns:xsi2="http://www.w3.org/2000/10/XMLSchema-instance"><ns0:purgeRequestResponse xmlns:ns0="http://www.akamai.com/purge"><return xsi1:type="ns0:PurgeResult" xsi2:type="ns0:PurgeResult" xsi:type="ns0:PurgeResult"><resultCode xsi1:type="xsd1:int" xsi2:type="xsd1:int" xsi:type="xsd1:int">100</resultCode><resultMsg xsi1:type="xsd1:string" xsi2:type="xsd1:string" xsi:type="xsd1:string">Success.</resultMsg><sessionID xsi1:type="xsd1:string" xsi2:type="xsd1:string" xsi:type="xsd1:string">0a761875-2635-11e2-b586-fb0e3586fb0e</sessionID><estTime xsi1:type="xsd1:int" xsi2:type="xsd1:int" xsi:type="xsd1:int">420</estTime><uriIndex xsi1:type="xsd1:int" xsi2:type="xsd1:int" xsi:type="xsd1:int">-1</uriIndex><modifiers SOAP-ENC:arrayType="xsd1:string[0]" xsi1:null="true" xsi2:null="true" xsi:nil="true"/></return></ns0:purgeRequestResponse></SOAP-ENV:Body></SOAP-ENV:Envelope>');
  // var res = new AkamaiPurgeResponse('<?xml version="1.0" encoding="UTF-8"?>'+
  //   '<SOAP-ENV:Envelope xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/"><SOAP-ENV:Body SOAP-ENV:encodingStyle="http://schemas.xmlsoap.org/soap/encoding/" xmlns:SOAP-ENC="http://schemas.xmlsoap.org/soap/encoding/" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsd1="http://www.w3.org/1999/XMLSchema" xmlns:xsd2="http://www.w3.org/2000/10/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsi1="http://www.w3.org/1999/XMLSchema-instance" xmlns:xsi2="http://www.w3.org/2000/10/XMLSchema-instance"><ns0:purgeRequestResponse xmlns:ns0="http://www.akamai.com/purge"><return xsi1:type="ns0:PurgeResult" xsi2:type="ns0:PurgeResult" xsi:type="ns0:PurgeResult"><resultCode xsi1:type="xsd1:int" xsi2:type="xsd1:int" xsi:type="xsd1:int">300</resultCode><resultMsg xsi1:type="xsd1:string" xsi2:type="xsd1:string" xsi:type="xsd1:string">Success.</resultMsg><sessionID xsi1:type="xsd1:string" xsi2:type="xsd1:string" xsi:type="xsd1:string">0a761875-2635-11e2-b586-fb0e3586fb0e</sessionID><estTime xsi1:type="xsd1:int" xsi2:type="xsd1:int" xsi:type="xsd1:int">420</estTime><uriIndex xsi1:type="xsd1:int" xsi2:type="xsd1:int" xsi:type="xsd1:int">-1</uriIndex><modifiers SOAP-ENC:arrayType="xsd1:string[0]" xsi1:null="true" xsi2:null="true" xsi:nil="true"/></return></ns0:purgeRequestResponse></SOAP-ENV:Body></SOAP-ENV:Envelope>');
...
function AkamaiPurgeRequestBody(urls, options) {
  var _urls = _.clone(urls || []),
    _options = _.clone(options || {});

  Object.defineProperties(this, {
    '_urls': {
      enumerable: false,
      get: function() { return _urls; },
      set: function(value) { _urls = value; }
    },
    '_options': {
      enumerable: false,
